    ...
    <div class="row cdvfdfd">
      <div class="col-lg-10 col-md-12 login-box">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 box-de"></div>
        </div>
      </div>
    </div>
  </div>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						<img class="img-fluid" src="<?= base_url('assets/landingTemplate'); ?>/img/login.jpg" alt="">
						<div class="hover">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
	...
	<script src="<?= base_url('assets/landingTemplate'); ?>/js/jquery.ajaxchimp.min.js"></script>
