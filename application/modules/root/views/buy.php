...
<body id="category">
    ...
    <div class="product_image_area">
        <div class="container">
            <form action="<?= base_url('root/placeOrders'); ?>" method="POST">
                <div class="row s_product_inner">
                    <div class="col-lg-6">
                        <?php if ($product->img) : ?>
                            <div class="owl-item active">
                                <div class="single-prd-item">
                                    <img class="img-fluid" style="width: 100%; height: auto;" src="<?= base_url('shoes/' . $product->img) ?>" alt="">
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                    <div class="col-lg-5 offset-lg-1">
                        <div class="s_product_text">
                            ...
                            <div class="product_count">
                                ...
                                <input type="text" name="order_qty" id="sst" maxlength="12" value="1" title="Quantity:" class="input-text qty">
                            ...
                            <div class="card_area d-flex align-items-center">
                                <input type="hidden" name="shoes_id" value="<?= $product->id ?>">
