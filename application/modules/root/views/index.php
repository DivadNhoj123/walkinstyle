...
<body class="main-layout">
    ...
    <div class="header_section">
        <div class="container">
            <div class="row">
                <div class="col-sm-3">
                    <div class="logo"><a href="#"><img src="<?= base_url('assets/landingTemplate'); ?>/img/logo.svg" style="height: 50px; width:fit-content;"></a></div>
                </div>
                <div class="col-sm-9">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <div class="banner_taital">
                                                <h1 class="banner_text">Walk N Style </h1>
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="best_shoes">
                        ...
                        <div class="shoes_icon"><img src="<?= base_url('assets/template'); ?>/images/shoes-img4.png"></div>
                        <div class="star_text">
                            <div class="left_part">
                                <ul>
                                    <li><a href="#"><img src="<?= base_url('assets/template'); ?>/images/star-icon.png"></a></li>
