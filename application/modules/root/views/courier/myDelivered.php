...
<body id="kt_body" data-kt-app-header-stacked="true" data-kt-app-header-primary-enabled="true" data-kt-app-header-secondary-enabled="true" data-kt-app-toolbar-enabled="true" class="app-default">
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            ...
            <?php $this->load->view('courier/template/_topbar'); ?>
                                                ...
                                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_products_table">
                                                    <thead>
                                                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                            ...
                                                            <th class="min-w-225px">Buyer</th>
                                                            <th class="text-end min-w-1px"></th>
                                                            <th class="text-start min-w-50px">Method</th>
                                                            <th class="text-end min-w-100px">Date Ordered</th>
                                                            <th class="text-center min-w-200px">Ship Address</th>
                                                            <th class="text-end min-w-1px"></th>
                                                        </tr>
                                                    </thead>
                                                            ...
                                                            <tr>
                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div class="d-flex align-items-center">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <div class="fs-7 text-muted">Total Amout: <div class="badge badge-light-warning"><?= $product->amount ?></div>
                                                                                </div>
                                                                                <!--end::Title-->
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <td class="d-flex align-items-center">
                                                                    ...
                                                                    <div class="d-flex flex-column">
                                                                        <a class="text-gray-800 text-hover-primary mb-1" data-kt-ecommerce-product-filter="product_name"><?= $product->first_name ?> <?= $product->last_name ?></a>
                                                                        <div class="fs-7 text-muted">Phone #: <?= $product->phone ?></div>
                                                                    </div>
                                                                    <!--begin::User details-->
                                                                </td>
                                                                <td class="text-end pe-0 text-capitalize" >
                                                                </td>
                                                                <td class="text-start pe-0 text-uppercase">
    ...
    <?php $this->load->view('courier/scripts'); ?>
</body>
<!--end::Body-->
