    ...
    <div class="d-flex align-items-center flex-stack flex-grow-1">
        <div class="app-header-logo d-flex align-items-center flex-stack px-lg-11 mb-2" id="kt_app_header_logo">
            ...
            <a href="../dist/index.html" class="app-sidebar-logo">
                <img alt="Logo" src="<?= base_url('assets/landingTemplate'); ?>/img/logo.svg" class="h-30px theme-light-show" />
                <img alt="Logo" src="<?= base_url('assets/landingTemplate'); ?>/img/logo.svg" class="h-30px theme-dark-show" />

            </a>
            <strong class="fs-2">Walk <strong class="text-warning">N</strong> Style</strong>
            <!--end::Logo-->
        ...
        <div class="app-navbar flex-grow-1 justify-content-end" id="kt_app_header_navbar">
            ...
            <div class="app-navbar-item ms-3 ms-lg-4 me-lg-2" id="kt_header_user_menu_toggle">
                ...
                <div class="cursor-pointer symbol symbol-30px symbol-lg-40px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                    <img src="<?= base_url('template'); ?>/media/avatars/blank.png" alt="user" />
                </div>
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="symbol symbol-50px me-5">
                                <img alt="Logo" src="<?= base_url('template'); ?>/media/avatars/blank.png" />
                            </div>
                            <!--end::Avatar-->
                            <!--begin::Username-->
                            <div class="d-flex flex-column">
                                <div class="fw-bold d-flex align-items-center fs-5">Walk N Style
                                    <span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">Admin</span>
                                </div>
                                <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">walkinstyle@test.com</a>
                            </div>
                            <!--end::Username-->
                        </div>
                    </div>
            ...
            <div class="app-navbar-item ms-3 ms-lg-4 me-lg-6">
                <!--begin::Link-->
                <h1 class=" btn-custom btn-color-gray-600 btn-active-color-primary w-35px h-35px w-md-40px h-md-40px">
