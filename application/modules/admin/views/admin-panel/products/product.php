                                            ...
                                            <tbody class="fw-semibold text-gray-600">
                                                <?php foreach ($shoes as $product) { ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-end pe-0"><?= $product->color ?></td>
                                                        <td class="text-end pe-0" data-order="Low Stock">
                                                            <?php if ($product->stock > 10) : ?>
                                                                <div class="badge badge-light-success">In Stock</div>
                                                            <?php else : ?>
                                                                <div class="badge badge-light-danger">Low Stock</div>
                                                            <?php endif; ?>
                                                        </td>
                                                        <td class="text-end">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a href="<?= base_url('admin/productEdit/') . $product->id ?>" class="menu-link px-3">Edit</a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                                <!--begin::Menu item-->
                                                                <div class="menu-item px-3">
                                                                    <a href="#" class="menu-link px-3" data-kt-ecommerce-product-filter="delete_row" data-product-id="<?= $product->id ?>">Delete</a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                            </div>
                                                            <!--end::Menu-->
