                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                ...
                                <div id="kt_app_content_container" class="app-container  container-fluid ">
                                    <!--begin::Form-->
                                    <form action="<?= base_url('admin/add_product'); ?>" method="POST" enctype="multipart/form-data" id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework">
                                        <!--begin::Aside column-->
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                    ...
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="product_brand" class="form-control mb-2" placeholder="Product name" value="">
                                                                    <!--end::Input-->
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                    ...
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="color" class="form-control mb-2" placeholder="Produt Color" value="">
                                                                    <!--end::Input-->
                                                                ...
                                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                    ...
                                                                    <!--begin::Input-->
                                                                    <input type="number" name="qty" class="form-control mb-2" placeholder="Product Quantity">
                                                                    <!--end::Input-->
