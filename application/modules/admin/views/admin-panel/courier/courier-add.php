                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_content" class="app-content flex-column-fluid">
                            ...
                            <div id="kt_app_content_container" class="app-container container-fluid">
                                ...
                                <div id="kt_app_content_container" class="app-container  container-fluid ">
                                    <!--begin::Form-->
                                    <form action="<?= base_url('admin/add_courier'); ?>" method="POST" enctype="multipart/form-data" id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework">
                                        <!--begin::Aside column-->
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="mb-2 fv-row fv-plugins-icon-container">
                                                        ...
                                                        <!--begin::Input-->
                                                        <input type="text" name="courier_email" class="form-control mb-2" placeholder="Email Address" value="">
                                                        <!--end::Input-->
                                                    </div>
                                                </div>
                                                <div class="card-body pt-0">
                                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                                        ...
                                                        <!--begin::Input-->
                                                        <input type="text" name="courier_phone" class="form-control mb-2" placeholder="Phone number" value="">
                                                        <!--end::Input-->
                                                    </div>
                                                </div>
                                                <!--end::Card body-->
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                    ...
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="courier_name" class="form-control mb-2" placeholder="First name" value="">
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="courier_lname" class="form-control mb-2" placeholder="Last name" value="">
                                                                    <!--end::Input-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                                    ...
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="courier_address" class="form-control mb-2" placeholder="Complete Address" value="">
                                                                    <!--end::Input-->
                                                                </div>
                                                                <!--end::Input group-->
                                                            </div>
